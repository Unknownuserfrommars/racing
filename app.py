...
def main() -> None:
    ...
    can_submit = bool(display_name and last_run_ms and last_run_ms > 3000)
    ...
    if last_run_ms is not None and last_run_ms <= 3000:
        st.warning("Run must be greater than 3 seconds to be considered valid.")
